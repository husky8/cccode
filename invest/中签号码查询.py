...
if __name__ == '__main__':
    # getBoundsRes("128096", 1704064610, 1000, "帅程", "奥瑞转债")
    getBoundsRes("128095", 1821022080, 1000, "帅程", "恩捷转债")
    # getBoundsRes("123041", 687712150, 1000, "哈哥", "东财转2")
    # getBoundsRes("123041", 691571660, 1000, "帅程", "东财转2")
